        ...
        {scrollItems.map((item, idx) => (
          ...
          >
            ...
            <div className="flex flex-col justify-center min-w-[120px] relative">
              <span className="font-accent text-sm font-medium uppercase tracking-[0.2em] text-gold-400/60 md:text-base group-hover/item:text-gold-400 transition-colors">
                {item.title}
              </span>

              {/* Expandable Hover Description Overlay (Pure CSS, upwards) */}
              {item.description && (
