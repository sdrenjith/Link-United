      ...
      <Container className="relative">
        ...
        <div className="mx-auto max-w-4xl">
              ...
              <TiltCard className="glass h-full rounded-2xl" intensity={6}>
                <div className="p-8">
                  <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-gold-400/10">
                    <svg className="h-5 w-5 text-gold-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="mt-1 text-sm font-medium text-gold-200/70">
                    LiNK UNITED INTERNATIONAL LIMITED
                  </p>
                  <p className="font-body mt-3 text-sm text-[#999999]">
          ...
          <motion.p
            ...
            className="font-body mt-12 text-center text-sm tracking-wide text-zinc-500"
          >
            Operating across{" "}
            <span className="text-gold-200/70">Europe</span> ·{" "}
            <span className="text-gold-200/70">Asia</span> ·{" "}
            <span className="text-gold-200/70">Middle East</span> ·{" "}
            <span className="text-gold-200/70">Americas</span>
          </motion.p>
        </div>
      </Container>
    </section>
